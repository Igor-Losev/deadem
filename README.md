...
| ------------------------------------------------------------------------------------------------------------ | ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| [01](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/01_parse.js)                       | Parse a single replay file                | `node ./packages/examples-node/scripts/01_parse.js`                                                                                                           |
| [02](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/02_parse_multiple.js)              | Parse multiple replay files               | `node ./packages/examples-node/scripts/02_parse_multiple.js --matches="36126255,36127043"`<br/>`node ./packages/examples-node/scripts/02_parse_multiple --matches=all` |
| [03](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/03_parse_http_broadcast.js)           | Parse HTTP Broadcast data from web server | `node ./packages/examples-node/scripts/03_parse_http_broadcast.js`                                                                                            |
| [04](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/04_parse_http_broadcast_file.js)   | Parse HTTP Broadcast data from file       | `node ./packages/examples-node/scripts/04_parse_http_broadcast_file.js`                                                                                       |
| [05](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/05_http_broadcast_save_to_file.js) | Save HTTP Broadcast data to a file        | `node ./packages/examples-node/scripts/05_http_broadcast_save_to_file.js`                                                                                     |
| [10](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/10_parse_game_time.js)             | Parse game duration from replay           | `node ./packages/examples-node/scripts/10_parse_game_time.js`                                                                                                 |
| [11](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/11_parse_top_damage_dealer.js)     | Identify top damage dealer                | `node ./packages/examples-node/scripts/11_parse_top_damage_dealer.js`                                                                                         |
| [12](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/12_parse_chat.js)                  | Extract chat messages                     | `node ./packages/examples-node/scripts/12_parse_chat.js`                                                                                                      |
| [13](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/13_parse_kill_feed.js)             | Extract kill feed events                  | `node ./packages/examples-node/scripts/13_parse_kill_feed.js`                                                                                                 |
| [14](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/14_parse_ability_feed.js)          | Extract ability usage events              | `node ./packages/examples-node/scripts/14_parse_ability_feed.js`                                                                                              |
| [15](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/15_parse_mid_boss_deaths.js)       | Parse mid boss death events               | `node ./packages/examples-node/scripts/15_parse_mid_boss_deaths.js`                                                                                           |
| [16](https://github.com/Igor-Losev/deadem/blob/main/packages/examples-node/scripts/16_parse_tower_deaths.js)          | Parse tower destruction events            | `node ./packages/examples-node/scripts/16_parse_tower_deaths.js`                                                                                              |
