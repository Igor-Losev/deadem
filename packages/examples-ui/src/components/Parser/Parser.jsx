        ...
        <Box display='flex' justifyContent='center' minHeight={0} marginY={2}>
          ...
          >
            ...
            <Typography variant='body2' color='text.secondary' marginTop={2} paragraph>
              This is <strong>Deadem Explorer</strong>, a tool that showcases the capabilities of the <code>deadem</code> library in a simplified way. Currently, this UI supports only the parsing of demo files (with the <code>.dem</code> extension). You can select any file from the Library or upload your own.
            </Typography>
